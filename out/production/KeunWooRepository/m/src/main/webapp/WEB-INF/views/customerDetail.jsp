	...
	function fnSave() {
		...
		if (t == true) {
			...
			$.ajax({ //동기통신 : 화면 안바뀌고 데이터만 주고받고 하는 것
				url : "/customerInsert2", //요청할 url, 주소:포트(http://localhost:8080)는 일반적으로 생략
	...
	<table style="width: 600px;">
		...
		<tr>
			...
			<td style="width: 30%"><input type="text"
				value='${customerDetail.NAME}' id="name"></td>
		</tr>
		<tr>
			<td style="width: 20%">생년월일</td>
			<td style="width: 30%"><input type="text"
				value='${customerDetail.BIRTH}' id="birth"></td>
		</tr>
		<tr>
			<td style="width: 20%">주소</td>
			<td style="width: 30%"><input type="text"
				value='${customerDetail.ADDRESS}' id="adress"></td>
		</tr>
		<tr>
			<td style="width: 20%">연락처</td>
			<td style="width: 30%"><input type="text"
				value='${customerDetail.CONTACT}' id="contact"></td>
		</tr>
